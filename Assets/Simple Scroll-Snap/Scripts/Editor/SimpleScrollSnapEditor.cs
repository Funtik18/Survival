...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : Editor
    {
        ...
        private void MovementType()
        {
            ...
            if (simpleScrollSnap.movementType == Assets.SimpleScrollSnap.MovementType.Fixed)
            {
        ...
        private void AutomaticLayout()
        {
            ...
            if (simpleScrollSnap.automaticallyLayout)
            {
                ...
                if (simpleScrollSnap.sizeControl == Assets.SimpleScrollSnap.SizeControl.Manual)
                {
                    EditorGUI.indentLevel++;
        ...
        {
            using (new EditorGUI.DisabledScope(simpleScrollSnap.movementType == Assets.SimpleScrollSnap.MovementType.Free))
            {
            ...
            if (simpleScrollSnap.movementType == Assets.SimpleScrollSnap.MovementType.Free)
            {
                simpleScrollSnap.snapTarget = Assets.SimpleScrollSnap.SnapTarget.Nearest;
            }
        }
